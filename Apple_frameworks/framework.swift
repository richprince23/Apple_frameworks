...
struct MockData {
    ...
    static let sampleFramework = Framework(id: UUID(),name: "ARKit",
                                           imageName: "arkit",
    ...
    static let frameworks = [
        ...
        Framework(id: UUID(),name: "ARKit",
                  imageName: "arkit",
                  urlString: "https://developer.apple.com/augmented-reality/arkit",
                  description: "ARKit 4 introduces a brand-new Depth API, creating a new way to access the detailed depth information gathered by the LiDAR Scanner on iPhone 12 Pro, iPhone 12 Pro Max, and iPad Pro.\n\nLocation Anchors leverages the higher-resolution data in Apple Maps to place AR experiences at a specific point in the world in your iPhone and iPad apps. And support for face tracking extends to all devices with the Apple Neural Engine and a front-facing camera, so even more users can experience the joy of AR in photos and videos."),
        
        Framework(id: UUID(),name: "CarPlay",
                  imageName: "carplay",
        ...
        Framework(id: UUID(),name: "Catalyst",
                  imageName: "catalyst",
        ...
        Framework(id: UUID(),name: "ClassKit",
                  imageName: "classkit",
        ...
        Framework(id: UUID(),name: "CloudKit",
                  imageName: "cloudkit",
        ...
        Framework(id: UUID(),name: "Core ML",
                  imageName: "coreml",
        ...
        Framework(id: UUID(),name: "HealthKit",
                  imageName: "healthkit",
        ...
        Framework(id: UUID(),name: "SF Symbols",
        ...
        Framework(id: UUID(),name: "SiriKit",
                  imageName: "sirikit",
        ...
        Framework(id: UUID(),name: "SpriteKit",
                  imageName: "spritekit",
        ...
        Framework(id: UUID(),name: "SwiftUI",
                  imageName: "swiftui",
        ...
        Framework(id: UUID(),name: "Test Flight",
        ...
        Framework(id: UUID(),name: "WidgetKit",
                  imageName: "widgetkit",
